...
const PrivacyPolicyPage = () => (
  <SecondLayout title='Privacy Policy' className={styles.privacyPage}>
    <div className='bg-white'>
      <div className='container'>
        <section className='section-head'>
          <div className='title-bar'>
            <h1>Privacy policy</h1>
            <span className='date'>Last updated: May 30, 2017</span>
          </div>
    ...
    <div className='container'>
      ...
      <section>
        ...
        <p>
          ...
          the following responsive action, should a data breach occur: We will
          ...
          questions. Process orders and to send information and updates
          pertaining to orders We may also send you additional information
          related to your product and/or service. Market to our mailing list or
          continue to send emails to our clients after the original transaction
          has occurred
          <br />
          <br />
      ...
      <section>
        ...
        <p>
          ...
          <br />
          <br />
          Quick Medigap 600 Congress Avenue Austin, Texas 78704 United States of
          America
        </p>
      </section>
    </div>
